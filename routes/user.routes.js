...
const { registerUser, loginUser, addEmergencyContacts, getEmergencyContacts, deleteEmergencyContact, loginUserMobile, loginUserMail, verifyOtp } = require('../controllers/user.controller');
